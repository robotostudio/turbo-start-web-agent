...
metadata:
  version: "2.11.1"
  # Required by .agents/skills/find-skills/SKILL.md for any skill not authored
  # for this project: the origin, named in the skill itself, so a reader who
  # opens this file knows it came from elsewhere without consulting the
  # lockfile. Pinned entry: skills-lock.json at the repo root.
