...
// note.
//
// Every Block that renders a button uses this. A Block writing its own
// `rounded-lg bg-primary px-6 py-3` is the defect this replaced: five copies
// of one design decision, and re-theming a client site meant finding all five.
// See the ButtonMatrix on /blocks-gallery for every variant and size rendered
// live.
