// Direction: Standard — comfortable default measure and rhythm, driven by
// @tailwindcss/typography's `prose` class. The plugin's own --tw-prose-*
// variables are remapped to our design tokens in globals.css, so this
// inherits the project's theme instead of the plugin's default greys.
export function ProseStandard() {
  return (
