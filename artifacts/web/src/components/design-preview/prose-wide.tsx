// Direction: Wide — deliberate contrast variant, pushed further than the
// other two, via `prose-lg` for a wider measure and larger body type. Driven
// by @tailwindcss/typography, whose --tw-prose-* variables are remapped to
// our design tokens in globals.css, so this inherits the project's theme
// instead of the plugin's default greys.
export function ProseWide() {
  return (
