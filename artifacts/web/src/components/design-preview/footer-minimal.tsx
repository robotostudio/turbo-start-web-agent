// Direction: Minimal — wordmark, one flat row of links, a legal line.
// Closest to the chrome-free house style: no border, no columns, no
// recessed band, whitespace alone separates it from whatever sits above.
...
export function FooterMinimal() {
  return (
    <footer className="font-sans">
      <div className="page-inset flex flex-col items-center gap-8 py-16 text-center sm:py-20">
